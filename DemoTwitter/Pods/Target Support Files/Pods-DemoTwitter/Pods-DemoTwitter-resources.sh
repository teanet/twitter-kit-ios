...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/../../TwitterKit/TwitterKitResources.bundle"
  ...
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPMutedBtn.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPMutedBtn@2x.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPMutedBtn@3x.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPPlayBtn.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPPlayBtn@2x.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPPlayBtn@3x.png"
  install_resource "${PODS_ROOT}/mopub-ios-sdk/MoPubSDK/Resources/MPUnmutedBtn.png"
